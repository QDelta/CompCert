...
Proof using. intros; reflexivity.
Qed.
...
Proof using. intros; unfold add. decEq. lia. Qed.
...
Proof using. rewrite xor_commut. apply xor_zero. Qed.

Theorem xor_one_one: xor one one = zero.
Proof using. apply xor_idem. Qed.
...
Module Wordsize_Ptrofs.
  ...
  Remark wordsize_not_zero: wordsize <> 0%nat.
  Proof using. unfold wordsize; destruct Archi.ptr64; congruence. Qed.
End Wordsize_Ptrofs.
